...
* **Microservo SG90:** Verificar que el movimiento del servo. Si el servo "tiembla", revisar la señal de control del Arduino.
* **Motores DC:** Limpiar cualquier residuo en los ejes de los dos motores de continua para evitar que el robot pierda el paralelismo en la prueba de desplazamiento.
...
* **Limpieza:** Los 3 sensores deben estar libres de polvo para garantizar la detección de obstáculos en el área de $2\text{ m}^2$.
...
* **Gestión Térmica:** Tras realizar la prueba de 2 minutos, verificar que el chip no presente sobrecalentamiento excesivo.
